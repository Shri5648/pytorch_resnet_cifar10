...
def main():
    ...
    # Use AdamW for 2D+ parameters (weight matrices)
    ...
    optimizers = [adamw_optimizer_2d, adamw_optimizer_1d]
    ...
    lr_schedulers = [
    torch.optim.lr_scheduler.MultiStepLR(adamw_optimizer_2d, milestones=[100, 150], last_epoch=args.start_epoch - 1),
    torch.optim.lr_scheduler.MultiStepLR(adamw_optimizer_1d, milestones=[100, 150], last_epoch=args.start_epoch - 1)
    ]
    ########################## Perplexity AI Code ##################################################
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print('current AdamW lr {:.5e}, AdamW lr {:.5e}'.format(adamw_optimizer_2d.param_groups[0]['lr'],adamw_optimizer_1d.param_groups[0]['lr'] if adamw_optimizer_1d.param_groups else 0))
...
if __name__ == '__main__':
    main()
    matlab_file_name='Varyinglr_AdamW_results.m'
    with open(matlab_file_name, "w") as f:
        f.write("%File written by trainer_varyinglr_AdamW.py\n")
