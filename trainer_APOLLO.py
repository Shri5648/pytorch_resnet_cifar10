...
parser.add_argument('--apollo-rank', default=256, type=int,
                    help='rank of auxiliary sub-space for APOLLO (default: 256 for APOLLO, 1 for APOLLO-Mini)')
parser.add_argument('--apollo-scale', default=1.0, type=float,
                    help='scale factor for APOLLO (default: 1.0 for APOLLO, 128 for APOLLO-Mini)')
parser.add_argument('--apollo-scale-type', default='channel', type=str, choices=['channel', 'tensor'],
                    help='scaling type: channel for APOLLO, tensor for APOLLO-Mini')
...
def main():
    ...
    # For standard APOLLO with channel-wise scaling
